import {
  require_jsx_runtime
} from "./chunk-X3ZOIBNG.js";
import {
  require_react
} from "./chunk-JPWKESLW.js";
import {
  __toESM
...
var r = class {
  constructor() {
    this.tiltAngleX = 0, this.tiltAngleY = 0, this.tiltAngleXPercentage = 0, this.tiltAngleYPercentage = 0, this.update = (t2, e2) => {
  ...
  constructor() {
    super(...arguments), this.wrapperEl = { node: null, size: { width: 0, height: 0, left: 0, top: 0 }, clientPosition: { x: null, y: null, xPercentage: 0, yPercentage: 0 }, updateAnimationId: null, scale: 1 }, this.tilt = null, this.glare = null, this.addDeviceOrientationEventListener = async () => {
      ...
      if ("function" == typeof t2) {
        return void ("granted" === await t2() && window.addEventListener("deviceorientation", this.onMove));
      }
